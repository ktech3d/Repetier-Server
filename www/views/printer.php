...
<div class="row" style="margin-top:10px">
    ...
    <div class="col-lg-9">
        <ul class="nav nav-tabs" id="printerTabs">
            <li><a href="#panel1" data-toggle="tab">Overview</a></li>
            <li><a href="#panel2" data-toggle="tab">Control</a></li>
            <li><a href="#panelConsole" data-toggle="tab">Console</a></li>
        ...
        <div class="tab-content">
            <div class="tab-pane active fade" id="panel1">
                <div class="row">
                    <div class="col-12 col-sm-8" id="control-row">
                        ...
                        <div style="float:left;width:40px;height:300px;padding:11px 10px">
                            <div id="control-vscoll-container" slider orientation="vertical"
                                 ...
                                 precision="1" ng-model="movoToYPos" style="height:300px"></div>
                            <br/>
                        </div>
                ...
                X : {{movoToXPos}} y:{{movoToYPos}}
            </div>
            <div class="tab-pane fade" id="panel2">
                <p>Content of section 2.</p>
                <!--  <slider floor="{{printerConfig[activeSlug].movement.xMin}}" ceiling="{{printerConfig[activeSlug].movement.xMax}}" step="0.5" precision="2" ng-model="setX"></slider> -->
